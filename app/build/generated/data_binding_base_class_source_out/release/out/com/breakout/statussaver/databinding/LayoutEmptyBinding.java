...
public final class LayoutEmptyBinding implements ViewBinding {
  ...
  private LayoutEmptyBinding(@NonNull LinearLayout rootView, @NonNull TextView tvEmptyMessage) {
  ...
  public static LayoutEmptyBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new LayoutEmptyBinding((LinearLayout) rootView, tvEmptyMessage);
    }
